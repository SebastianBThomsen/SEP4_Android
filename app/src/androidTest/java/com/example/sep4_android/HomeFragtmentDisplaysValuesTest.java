...
public class HomeFragtmentDisplaysValuesTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void homeFragtmentDisplaysValuesTest() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.tv_temperatures), withText("temp values: "),
                        withParent(withParent(withId(R.id.nav_host_fragment_content_main))),
                        isDisplayed()));
        textView2.check(matches(withText("temp values: ")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.tv_humidity), withText("hum values: "),
                        withParent(withParent(withId(R.id.nav_host_fragment_content_main))),
                        isDisplayed()));
        textView3.check(matches(withText("hum values: ")));
    }
